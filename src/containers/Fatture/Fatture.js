...
class Fatture extends React.Component {
    ...
    static Form = CreateForm('fatture', 'invoices')
    ...
    handleFileRemove(index, event) {
        ...
        this.props.dispatch(Actions.removeInvoice({index}))
    }

    handleReset(e) {
        this.props.dispatch(Actions.resetInvoice())
